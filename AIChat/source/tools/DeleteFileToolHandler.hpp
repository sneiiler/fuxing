// -----------------------------------------------------------------------------
// File: DeleteFileToolHandler.hpp
// Author: Yin, Kaifeng
// Email: ykf@live.cn
// Date: 2026-02-24
// Version: 1.0.0
...
#ifndef AICHAT_DELETE_FILE_TOOL_HANDLER_HPP
#define AICHAT_DELETE_FILE_TOOL_HANDLER_HPP
...
/// Tool handler for deleting a file within the workspace sandbox.
class DeleteFileToolHandler : public IToolHandler
{
public:
   explicit DeleteFileToolHandler(PathAccessManager* aPathAccess = nullptr);
...
#endif // AICHAT_DELETE_FILE_TOOL_HANDLER_HPP
