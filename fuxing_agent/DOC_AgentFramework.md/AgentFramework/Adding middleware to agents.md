...
- Adding middleware to agents
- [https://learn.microsoft.com/en-us/agent-framework/agents/middleware/defining-middleware?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/defining-middleware?pivots=programming-language-csharp)
- How to add middleware to an agent
- 2026-03-04 19:15

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/middleware/defining-middleware.md)
...
Function calling middleware is currently only supported with an `AIAgent`​ that uses [FunctionInvokingChatClient](https://learn.microsoft.com/en-us/dotnet/api/microsoft.extensions.ai.functioninvokingchatclient), for example, `ChatClientAgent`.
...
For agents that are built using [IChatClient](https://learn.microsoft.com/en-us/dotnet/api/microsoft.extensions.ai.ichatclient), you might want to intercept calls going from the agent to the `IChatClient`​. In this case, it's possible to use middleware for the `IChatClient`.
...
For more information about `IChatClient`​ middleware, see [Custom IChatClient middleware](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai#custom-ichatclient-middleware).

## Step 7: Add Chat client Middleware to an `IChatClient`

To add middleware to your [IChatClient](https://learn.microsoft.com/en-us/dotnet/api/microsoft.extensions.ai.ichatclient), you can use the builder pattern. After adding the middleware, you can use the `IChatClient` with your agent as usual.
...
For more advanced scenarios, see the [Agent Middleware User Guide](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/), which covers:
...
[Chat-Level Middleware](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/chat-middleware)

Ask Learn is an AI assistant that can answer questions, clarify concepts, and define terms using trusted Microsoft documentation.

Please sign in to use Ask Learn.

[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/defining-middleware?pivots=programming-language-csharp#)
