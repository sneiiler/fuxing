...
- Agent vs Run Scope
- [https://learn.microsoft.com/en-us/agent-framework/agents/middleware/agent-vs-run-scope?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/agent-vs-run-scope?pivots=programming-language-csharp)
- Learn about agent-level and run-level middleware scoping in Agent Framework.
- 2026-03-04 19:15

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/middleware/agent-vs-run-scope.md)
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/agent-vs-run-scope?pivots=programming-language-csharp#)
