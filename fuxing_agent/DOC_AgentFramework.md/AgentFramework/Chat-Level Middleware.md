...
- Chat-Level Middleware
- [https://learn.microsoft.com/en-us/agent-framework/agents/middleware/chat-middleware?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/chat-middleware?pivots=programming-language-csharp)
- Learn how to implement chat-level middleware in Agent Framework.
- 2026-03-04 19:15

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/middleware/chat-middleware.md)
...
[Agent vs Run Scope](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/agent-vs-run-scope)
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/chat-middleware?pivots=programming-language-csharp#)
