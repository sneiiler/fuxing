...
- Result Overrides
- [https://learn.microsoft.com/en-us/agent-framework/agents/middleware/result-overrides?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/result-overrides?pivots=programming-language-csharp)
- Learn how to override agent results using middleware.
- 2026-03-04 19:16

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/middleware/result-overrides.md)
...
[Exception Handling](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/exception-handling)
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/result-overrides?pivots=programming-language-csharp#)
