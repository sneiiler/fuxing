...
- Shared State
- [https://learn.microsoft.com/en-us/agent-framework/agents/middleware/shared-state?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/shared-state?pivots=programming-language-csharp)
- Learn how to share state across middleware components.
- 2026-03-04 19:16

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/middleware/shared-state.md)
...
[Runtime Context](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/runtime-context)
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/shared-state?pivots=programming-language-csharp#)
