...
- Storage
- [https://learn.microsoft.com/en-us/agent-framework/agents/conversations/storage?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/conversations/storage?pivots=programming-language-csharp)
- Learn built-in storage modes and how to persist session state or plug in external storage.
- 2026-03-04 19:15

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/conversations/storage.md)
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/conversations/storage?pivots=programming-language-csharp#)
