...
- Termination & Guardrails
- [https://learn.microsoft.com/en-us/agent-framework/agents/middleware/termination?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/termination?pivots=programming-language-csharp)
- Learn how to implement termination conditions and guardrails with middleware.
- 2026-03-04 19:16

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/middleware/termination.md)
...
[Result Overrides](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/result-overrides)
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/middleware/termination?pivots=programming-language-csharp#)
