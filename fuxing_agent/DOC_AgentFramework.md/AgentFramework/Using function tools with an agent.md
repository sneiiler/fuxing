...
- Using function tools with an agent
- [https://learn.microsoft.com/en-us/agent-framework/agents/tools/function-tools?pivots=programming-language-csharp](https://learn.microsoft.com/en-us/agent-framework/agents/tools/function-tools?pivots=programming-language-csharp)
- Learn how to use function tools with an agent
- 2026-03-04 19:14

---

- [Edit](https://github.com/MicrosoftDocs/semantic-kernel-docs/blob/main/agent-framework/agents/tools/function-tools.md)
...
For prerequisites and installing Python packages, see the [Create and run a simple agent](https://learn.microsoft.com/en-us/agent-framework/agents/running-agents) step in this tutorial.
...
When you need full control over the schema exposed to the model, pass the `schema`​ parameter to `@tool`. You can provide either a Pydantic model or a raw JSON schema dictionary.
...
If a tool is implemented outside the framework (for example, client-side in a UI), you can declare it without an implementation using `FunctionTool(..., func=None)`. The model can still reason about and call the tool, and your application can provide the result later.
...
[Sign in](https://learn.microsoft.com/en-us/agent-framework/agents/tools/function-tools?pivots=programming-language-csharp#)
