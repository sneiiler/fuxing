...
namespace FuXingAgent
{
    public class StartupWarningDialog : AntdUI.Window
    {
        ...
        static readonly Color ACCENT = Color.FromArgb(245, 158, 11);
        ...
        private void InitializeComponent()
        {
            ...
            var iconPanel = new Panel { Dock = DockStyle.Top, Height = 70, BackColor = BG };
            iconPanel.Paint += (s, e) =>
            {
                var g = e.Graphics;
                ...
                int cy = 10;
                using (var brush = new SolidBrush(Color.FromArgb(254, 243, 199))) g.FillEllipse(brush, cx, cy, circleSize, circleSize);
            ...
            var footer = new Panel { Dock = DockStyle.Bottom, Height = 100, BackColor = BG };
            ...
            var divider = new Panel { Dock = DockStyle.Bottom, Height = 1, BackColor = BORDER };
