...
& $msbuild "$PSScriptRoot\fuxing_agent.csproj" /p:Configuration=$Configuration /p:Platform=AnyCPU /m /nologo /verbosity:minimal
...
if ($Configuration -eq "Debug") {
    $dllPath = "$PSScriptRoot\bin\Debug\FuXingAgent.dll"
